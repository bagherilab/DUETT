...
event_locations1 = read.csv("analysis/F_subtract/replicates/F_subtract_1.csv")
event_locations2 = read.csv("analysis/F_subtract/replicates/F_subtract_2.csv")
event_locations3 = read.csv("analysis/F_subtract/replicates/F_subtract_3.csv")
...
pdf("analysis/F_subtract/replicates/replicate_shared_events.pdf", width = 14, height = 14)
make_visual(data_mat, event_locations_shared_all, concurrent_events_all, log_colors = T, diverging = T)
make_visual(data_mat, event_locations_shared_2, concurrent_events_2, log_colors = T, diverging = T)
dev.off()
...
event_locations1[20:30,13]
event_locations2[20:30,13]
event_locations3[20:30,13]

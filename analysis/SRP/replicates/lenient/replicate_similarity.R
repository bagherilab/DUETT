...
event_locations1 = read.csv("analysis/SRP/replicates/lenient/lenient_1.csv")
event_locations2 = read.csv("analysis/SRP/replicates/lenient/lenient_2.csv")
event_locations3 = read.csv("analysis/SRP/replicates/lenient/lenient_3.csv")
...
pdf("analysis/SRP/replicates/lenient/replicate_shared_events.pdf", width = 14, height = 14)
